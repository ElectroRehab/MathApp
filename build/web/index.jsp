            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Absolute and Relative Difference</h3>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body"><label class="form-label">Absolute Difference ($)<input type="text" name="absoDif" placeholder="<%out.print(first);%>"></label><label class="form-label">Relative Difference (Dec)<input type="text" name="relDiff" placeholder="<%out.print(second);%>"></label><label class="form-label">Relative Difference (%)<input type="text" name="absoDif" placeholder="%" value="<%out.print(third);%>"></label></div>
                                <div class="card-body"><img style="background: url(&quot;assets/img/dogs/AbsoRel.JPG&quot;);" src="assets/img/dogs/AbsoRel.JPG"></div>
                            </div>
                        </div>
                        <div class="col"></div>
                    </div>
