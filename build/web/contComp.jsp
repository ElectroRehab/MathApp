<%-- 
    Document   : contComp
    Created on : Mar 13, 2022, 1:20:18 PM
    Author     : 01ele
--%>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Continuous Compounding Interest</h3>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body"><label class="form-label">Answer($)<input type="text" name="absoDif" placeholder="$<%out.print(first);%>"></label></div><label class="form-label" style="font-size: 24px;"><img src="assets/img/dogs/ContCompound.JPG"><br></label>
                            </div>
                        </div>
                        <div class="col"></div>
                    </div>
