            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Compound Interest</h3>
                    </div>
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Compound Interest</h6>
                                </div>
                                <section class="contact-clean">
                                    <form method="post" action="allCalc.jsp">
                                        ...
                                        <%if(fourth==null){%>
                                            ...
                                            <input type="hidden" name="whatCalc" value="compoundCalc">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body"><label class="form-label">Answer($)<input type="text" name="absoDif" placeholder="$<%out.print(first);%>"></label></div><label class="form-label" style="font-size: 24px;"><img src="assets/img/dogs/Compound.JPG"><br></label>
                            </div>
                        </div>
                        <div class="col"></div>
                    </div>
